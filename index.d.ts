 ...
 */
declare abstract class OrderedCollection<V, E, Absent = AbsentValue> extends HasLength {
    /**
 ...
 */
declare class MultiKeyQueue<K, V extends IndexedOrderedCollection<K, K, E>, E = K> extends IndexedOrderedCollectionWithOrderedKeys<K, V, ListNode<V>> {
    list: LinkedList<V>;
