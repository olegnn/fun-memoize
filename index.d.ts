 ...
 */
declare abstract class CacheStrategy<V> extends HasCapacity implements Clearable, Parent<V> {
    constructor(capacity: number);
    /**
 ...
 * Key-value storage.
 */
declare abstract class Storage<K, V> extends HasLength implements Destroyable, Clearable, Parent<K> {
    /**
    ...
    destroyed: boolean;
    constructor(params?: StorageParams<K, V>, parentPaths?: Iterable<ChildPath<K | Storage<K, V>>>);
    /**
...
declare class LeafStorage<K, V> extends Storage<K, V> implements Destroyable {
    ...
    constructor(storage: Storage<K, V>, strategy: CacheStrategy<K>, params: LeafStorageParams<K, V>, rootPath?: Iterable<ChildPath<K>>);
    /**
 ...
 */
type NestedStorage<K, V> = LeafStorage<K, V> | Storage<K, NestedStorage<K, V> | LeafStorage<K, V> | V>;
/**
 * Params for the storage context.
 */
interface Params<K, V> extends UnifiedStorageParams<K, V>, LeafStorageParams<K, V>, StorageParams<K, V> {
    /**
     ...
     */
    strategy?: StrategyConfig<K, V> | CacheStrategyClass<K | LeafStorage<K, V> | NestedStorage<K, V>>;
}
/**
 ...
 * @param params
 */
declare function memoize<V>(func: (...args: any[]) => V, { length, checkLast, ...params }?: ParamsWithLength<any, V>): typeof func & {
 ...
 */
declare abstract class OrderedCollection<Value, Item, Absent = AbsentValue> extends HasLength {
    /**
 ...
 */
declare abstract class IndexedOrderedCollection<Key, Value, Item, Absent = AbsentValue> extends OrderedCollection<Value, Item, Absent> {
    /**
 ...
 * while **Key `->` Item** relation always holds one-to-one.
 */
declare abstract class IndexedOrderedCollectionWithOrderedKeys<Key, Value, Item, Absent = AbsentValue> extends IndexedOrderedCollection<Key, Value, Item, Absent> {
    /**
...
declare class ListNode<T> {
    ...
    value: T;
    constructor(value: T, root: LinkedList<T>, prev?: ListNode<T> | null, next?: ListNode<T> | null);
    /**
 ...
 */
declare class MultiKeyQueue<Key, Item extends IndexedOrderedCollection<Key, Key, InnerItem>, InnerItem = Key> extends IndexedOrderedCollectionWithOrderedKeys<Key, Item, ListNode<Item>> {
 ...
 */
declare class Single<V> extends IndexedOrderedCollectionWithOrderedKeys<V, V, V> {
    value: V | AbsentValue;
    constructor(value: V);
 ...
 */
declare class SingleKeyQueue<V> extends IndexedOrderedCollectionWithOrderedKeys<V, V, ListNode<Single<V>>> {
     ...
     *
     */
    insertAfter(node: ListNode<Single<V>>, value: V): ListNode<Single<V>> | AbsentValue;
    /**
     * Inserts given value before the supplied raw linked list node.
     * @param node
     * @param key
     *
     */
    insertBefore(node: ListNode<Single<V>>, value: V): ListNode<Single<V>> | AbsentValue;
    /**
     * Returns value associated with the given key or `NO_VALUE` if the value wasn't found.
     * @param key
     *
...
export { DEFAULT_MAX_ENTRIES_COUNT, FIFO, LFU, LRU, createMemoizedSelector, memoize as default, memoize };
